...
import com.fcp.tec.informatec.adapters.ExpandableListAdapterPreguntas;
import com.fcp.tec.informatec.provider.ContractPreguntasFrecuentes;
...
public class OneFragmentItem_Preguntas extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        uSincronizacion.sincronizarAutomaticamente(this, ContractPreguntasFrecuentes.AUTORIDAD);
