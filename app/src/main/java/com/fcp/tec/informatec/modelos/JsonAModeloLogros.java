package com.fcp.tec.informatec.modelos;
...
public class JsonAModeloLogros
{
    ...
    //Se declara una variable que contendrá un "mapa" de los Logros remotos (se almacenan como OBJETOS, los que acabamos de leer del JSON remoto)
    ...
    public void procesar(JSONArray arrayJson)
    {
        ...
        {
            //Se añade UN id a cada logro encontrado en Logros[]
    ...
    public void procesarOperaciones(ArrayList<ContentProviderOperation> cpOperaciones, ContentResolver cResolver)
    {
        ...
        {
            Log.i(TAG, "Programar inserción de NUEVO Logro con ID = " + logros.getIdLogro());
