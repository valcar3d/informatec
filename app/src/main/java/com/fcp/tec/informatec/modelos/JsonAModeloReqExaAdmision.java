...
public class JsonAModeloReqExaAdmision
{
    ...
    //Se declara una variable que contendrá un "mapa" de los requisitos remotos (aqui se almacena el que acabamos de leer del JSON remoto)
    ...
    public void procesarOperaciones(ArrayList<ContentProviderOperation> cpOperaciones, ContentResolver cResolver)
    {
        ...
        if (c != null)
        {
            while (c.moveToNext())
            {
                ...
                if (match != null)
                {
                    ...
                    //Crear una URI de este Requisito
        ...
        {
            Log.i(TAG, "Programar inserción de NUEVO requisito con ID = " + requisito.getIdInscripcion());
