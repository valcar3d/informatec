...
import com.fcp.tec.informatec.modelos.JsonAModeloLogros;
import com.fcp.tec.informatec.provider.ContractLogros;
...
public class SyncAdapterLogros extends AbstractThreadedSyncAdapter
{
    ...
    private void procesarGET(JSONObject response)
    {
        try
        {
            ...
            Log.i(TAG, "procesarGET: el valor de OPERACIONES ES: "+cpOperaciones.toString());
            ...
            //Se procesa la respuesta JSON y se convierte a objeto Logros.java
            ...
            if (cpOperaciones.size() > 0 && cpOperaciones != null)
            {

                Log.i(TAG, "Cambios en \'logros\': " + cpOperaciones.size() + " operaciones");
